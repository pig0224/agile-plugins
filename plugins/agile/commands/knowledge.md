...
2. 说的是系统怎么实现、为什么这么设计？→ `team`（架构决策、框架用法、工程约定；组件 API 约定、组件库用法落 `frameworks/<前端栈>/`）
3. 说的是业务规则、用户看到什么？→ `product`（PRD、UI/交互规范、业务规则；视觉规则、交互模式——含 token 语义）
